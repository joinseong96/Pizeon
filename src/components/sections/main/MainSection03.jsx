...
const sectionItems = [
	{
		...
		txtWidth: "w-[450px] max-ta:w-[calc(100vw*(450/1700))]",
		href: "#",
	...
	},
	{
		...
		txtWidth: "w-[425px] max-ta:w-[calc(100vw*(450/1700))]",
		href: "#",
	...
	},
	{
		...
		txtWidth: "w-[535px] max-ta:w-[calc(100vw*(450/1700))]",
		href: "#",
...
export default function MainSection03() {
	...
	return (
		<div
			className="flex w-full h-[528px] max-ta:h-[calc(100vw*(528/1700))]"
		...
		>
				...
				{titItems.map((t, i) => (
					<li
						...
						className={`cursor-pointer transition-all duration-300 ${
							activeItem === i
								? "text-[72px] text-white max-ta:text-[calc(100vw*(72/1700))]"
								: "text-[38px] font-medium text-white/60 max-ta:text-[calc(100vw*(38/1700))]"
						}`}
			...
			<div className="relative w-1/2 flex flex-col justify-center items-center text-white z-[1]">
				...
				<div className="mb-[24px] text-[28px] font-medium max-ta:mb-[calc(100vw*(24/1700))] max-ta:text-[calc(100vw*(28/1700))]">
					{sectionItems[activeItem].sub}
				</div>
				<p
					className={`mb-[64px] text-[20px] font-normal text-center max-ta:mb-[calc(100vw*(64/1700))] max-ta:text-[calc(100vw*(20/1700))] ${sectionItems[activeItem].txtWidth}`}
				>
					{sectionItems[activeItem].txt}
				</p>
				<a
					href={sectionItems[activeItem].href}
					className="text-[20px] font-medium max-ta:text-[calc(100vw*(20/1700))]"
				>
					view more
				</a>
			</div>
