...
export default function NewsList({ currentPage }) {
	...
	return (
		<div className="w-[1636px] mx-auto mb-[clamp(50px,calc(100vw*(100/1700)),100px)] max-ta:w-[calc(100vw*(1540/1700))] max-mo:w-[calc(100vw*(320/360))]">
			<ul className="flex flex-wrap gap-y-[clamp(30px,calc(100vw*(80/1700)),80px)] gap-x-[clamp(10px,calc(100vw*(20/1700)),20px)]">
				{currentItems.map((item, i) => (
					<li
						key={i}
						className="w-[808px] max-ta:w-[calc(100vw*(759/1700))] max-mo:w-[100%]"
					>
						...
						<div>
							...
							<p className="mb-[clamp(10px,calc(100vw*(25/1700)),35px)] text-[clamp(12px,calc(100vw*(24/1700)),24px)] font-semibold text-[#222]">
								{item.title}
							</p>
