	...
	const brandItems = [
		{
			...
			alt: "피죤",
			width: "w-[clamp(250px,calc(100vw*(1084/1700)),1084px)] max-mo:w-[100%]",
		},
		{
			title: "퓨어",
			desc: "잦은 손 세정에도 걱정없는\n 촉촉 핸드솝",
			...
			alt: "퓨어",
			width: "w-[clamp(250px,calc(100vw*(532/1700)),532px)] max-mo:w-[100%]",
		},
		{
			title: "무균무때",
			desc: "옥수수와 곡물로 발효한\n 발효주정 70% 함유",
	...
	return (
		<section className="w-[1636px] m-auto max-ta:w-[calc(100vw*(1638/1700))] max-mo:w-[calc(100vw*(320/360))]">
            ...
            after:transition-colors after:duration-300 cursor-pointer ${item.width} max-mo:after:bg-black/30`}
					>
						<div className="h-[clamp(100%,calc(100vw*(700/1700)),700px)]">
							<img
